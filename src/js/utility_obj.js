...
const buildingWorkersLevel = {
    "townhall" : [{level: 1, workerType: "manant"},
        {level: 2, workerType: "manant"},
        {level: 3, workerType: "manant"}],
    "farm" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "master_Farmer"}],
    "mine" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "miner"}],
    "livestock_ranches" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "rancher"}],
    "fishing_hut" : [{level: 1, workerType: "hookman"},
        {level: 2, workerType: "netter"},
        {level: 3, workerType: "fisherman"}],
    "lumberjack_hut" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "lumberjack"}],
    "lumber_mill" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "sawyer"}],
    "quarry" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "stonemason"}],
    "forge" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "blacksmith"}],
    "mill" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "miller"}],
    "market" : [{level: 1, workerType: "marchant"},
        {level: 2, workerType: "courtier"},
        {level: 3, workerType: "gestionnaire"}],
    ...
    "sheep_ranches" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "rancher"}],
    "textile_mill" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "weaver"}],
    "shipyard" :  [{level: 1, workerType: "apprenti"},
        {level: 2, workerType: "charpentier"},
        {level: 3, workerType: "master_builder"}],
    "dockyard" :  [{level: 1, workerType: "apprenti"},
        {level: 2, workerType: "charpentier"},
        {level: 3, workerType: "master_shipwright"}],
    "clothing_workshop" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "tailor"}],
    "brewery" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "brewer"}],
    "tobacco_workshop" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "tobacconist"}],
    "cacao_workshop" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "chocolatier"}],
    "coffee_workshop" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
        {level: 3, workerType: "barista"}],
    "jewelry_workshop" : [{level: 1, workerType: "ouvrier"},
        {level: 2, workerType: "apprenti"},
...
const workersConsumption = {
    ...
    charpentier: { food: 2, clothes: 1, liquor: 1 },
    ...
    marchant: { food: 2, clothes: 1, ground_coffee: 1 }, 
    courtier: { food: 1, chocolate: 1, jewelry: 1 }, 
    gestionnaire: { food: 1, cigars: 1, jewelry: 1 }, 
    ...
    barista: { food: 2, ground_coffee: 1, jewelry: 1 }, 
